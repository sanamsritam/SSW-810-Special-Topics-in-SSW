    ...
    def compute_gpa(self) -> float:
        ...
        for i in self._courses.values():
            if i in self._grade:
                ...
                print("Invalid grade")
        for i in self._courses_fail.values():
            if i in self._grade:
                Gpas.append(self._grade[i])
            else:
                print("Invalid grade")
...
class Repository:
    ...
    """
    __slots__ = ['_path', '_db_path', '_students', '_instructors', '_majors']
...
def main():
    stevens: Repository = Repository(
        r"C:\\Users\\sanam\\Documents\Desk\\SSW 810 B\\Assignments\\HomeWork 11",
        r"C:\\Users\\sanam\\Documents\\Desk\\SSW 810 B\\Assignments\\HomeWork 11\\Homework11.db")
