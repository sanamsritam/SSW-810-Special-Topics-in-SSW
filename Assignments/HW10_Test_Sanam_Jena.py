...
import unittest
from HW10_Sanam_Jena import Repository, Student, Instructor, Major
...
class HW10TestCase(unittest.TestCase):
    ...
    def test_students(self):
        ...
        test_cwid: List[str] = ['10103', '10115', '10172', '10175',
                                '10183', '11399', '11461', '11658', '11714',
                                '11788']
        test_name: List[str] = ['Baldwin, C', 'Wyatt, X', 'Forbes, I',
                                'Erickson, D',
                                'Chapman, O', 'Cordova, I', 'Wright, U',
                                'Kelly, P', 'Morton, A', 'Fuller, E']
        test_major: List[str] = ['SFEN', 'SFEN', 'SFEN', 'SFEN',
                                 'SFEN', 'SYEN', 'SYEN', 'SYEN', 'SYEN',
                                 'SYEN']
        test_cc: List[List[str]] = ["['CS 501', 'SSW 564', 'SSW 567', 'SSW 687']",
    ...
    def test_major(self):
        ...
        test_rc: List[List[str]] = [
            "['SSW 540', 'SSW 564', 'SSW 555', 'SSW 567']", "['SYS 671', 'SYS 612', 'SYS 800']"]
        test_elec: List[List[str]] = [
            "['CS 501', 'CS 513', 'CS 545']", "['SSW 810', 'SSW 565', 'SSW 540']"]
        self.assertEqual(major, test_major)
